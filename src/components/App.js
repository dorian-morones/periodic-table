  ...
  render() {
    ...
    return (
      <div className="wrapper">
        <h1 className="center mainTitle">The Periodic Table of Elements</h1>
              ...
              <div id="information">
                ...
                <div>
                  ...
                  <div className="atom_info">
                    <p><strong>Atomic Mass:</strong> {atomic_mass}</p>
                    <p><strong>Density:</strong> {density}</p>
                    {molar_heat ? <p><strong>Molar Heat:</strong> {molar_heat}</p> : ''}
                    {melt ? <p><strong>Melt:</strong> {melt}K</p> : null}
                    {boil ? <p><strong>Boil:</strong> {boil}K</p> : null}
                  </div>
                  <div className="atom_summary">
